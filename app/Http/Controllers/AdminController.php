...
class AdminController extends Controller
{
    public function index()
    {
        ...
        try {
            $contacts = Hubspot::contactProperties()->all();
            ...
            if(method_exists($e, 'getResponse')) {
                ...
                foreach($contacts->getData() as $contact_property) {
                    if ($contact_property->groupName == 'lead_ads'){
                        $info = ['propiedad' => $contact_property->name,];
                    }
        ...
        return view('home')->with('data', $contacts->getdata());
    }
